...
> This function has been removed. User yield accrues automatically through the **stQEURO** wrapper (rising exchange rate); there is no staking-reward claim call.
