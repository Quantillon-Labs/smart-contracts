# TimeProvider
[Git Source](https://github.com/Quantillon-Labs/smart-contracts/quantillon-protocol/blob/02318f592f770a9d926016c8576b44854e674b9a/src/libraries/TimeProviderLibrary.sol)
...
|Name|Type|Description|
|----|----|-----------|
|`offset`|`int256`|Signed time offset in seconds|
