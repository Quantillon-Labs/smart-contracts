...
├── SUMMARY.md                           # mdBook nav for the guide pages (+ generated contract tree)
├── API-Reference.md                     # Technical API reference
├── Quick-Start.md                       # Quick start guide
├── Integration-Examples.md              # Integration examples
├── Architecture.md                      # Architecture overview
├── Oracle-Architecture.md               # Oracle design (Hyperliquid active, Chainlink fallback)
├── Security.md                          # Security guide
├── Deployment.md                        # Deployment guide
├── stQEUROFactory.md                    # Multi-vault staking refactor (historical record)
├── Multi-Vault-Staking-Flow.md          # Runtime routing after the vaultId refactor
├── Staking-Yield-Distribution.md        # How yield reaches stQEURO stakers
├── External-Vault-Onboarding-Runbook.md # Post-core adapter onboarding
├── Bundle-Release-2026-08-26.md         # Release runbook (repo-only, not published to the site)
├── CONTRIBUTING.md                      # This file
├── LICENSE
└── src/                                 # GENERATED by forge doc — never hand-edit
```

### Naming Conventions

- Guide file names are Capitalised-Kebab-Case and become the published URL: `Quick-Start.md` → `https://smartcontracts.quantillon.money/Quick-Start.html` (the publish workflow copies the file by name, so the casing matters)
