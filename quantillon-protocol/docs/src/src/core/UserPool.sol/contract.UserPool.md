# UserPool
[Git Source](https://github.com/Quantillon-Labs/smart-contracts/quantillon-protocol/blob/02318f592f770a9d926016c8576b44854e674b9a/src/core/UserPool.sol)
...
|`_vault`|`address`|QuantillonVault address|
|`_oracle`|`address`|Oracle address|
|`_yieldShift`|`address`|YieldShift address|
