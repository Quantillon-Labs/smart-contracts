...
import {AaveVaultAdapter} from "../src/core/vaults/AaveVaultAdapter.sol";
...
/**
 * @title AaveVaultAdapterTestSuite
...
contract AaveVaultTestSuite is Test {
    ...
    AaveVaultAdapter public implementation;
    AaveVaultAdapter public mockAaveVault;
    MockUSDC public usdc;
    MockAUSDC public aUSDC;
    ...
    function setUp() public {
        ...
        implementation = new AaveVaultAdapter();
        
        // Deploy proxy
        bytes memory initData = abi.encodeWithSelector(
            AaveVaultAdapter.initialize.selector,
            admin,
            address(usdc),
        ...
        mockAaveVault = AaveVaultAdapter(address(proxy));
    ...
    function test_Initialization_ZeroAdmin_Revert() public {
        AaveVaultAdapter newImplementation = new AaveVaultAdapter();
    ...
    function test_YieldManagement_HarvestAaveYield_NoYieldVaultId_Revert() public {
        AaveVaultAdapter localImpl = new AaveVaultAdapter();
        bytes memory initData = abi.encodeWithSelector(
            AaveVaultAdapter.initialize.selector,
            admin,
            address(usdc),
        ...
        AaveVaultAdapter localVault = AaveVaultAdapter(address(proxy));
