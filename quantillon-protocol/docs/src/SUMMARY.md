...
# src
  ...
  - [❱ libraries](src/libraries/README.md)
    ...
    - [StakingYieldLibrary](src/libraries/StakingYieldLibrary.sol/library.StakingYieldLibrary.md)
  ...
  - [❱ mocks](src/mocks/README.md)
    ...
    - [MockAggregatorV3](src/mocks/MockAggregatorV3.sol/contract.MockAggregatorV3.md)
  ...
  - [❱ oracle](src/oracle/README.md)
    ...
    - [ISlippageMidSource](src/oracle/LighterEurUsdOracle.sol/interface.ISlippageMidSource.md)
