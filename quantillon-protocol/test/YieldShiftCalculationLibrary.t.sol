...
contract YieldShiftCalculationLibraryTest is Test {
     ...
     */
    function test_CalculateOptimalYieldShift_HedgerPoolZero_ReturnsMaxShift() public {
     ...
     */
    function test_CalculateOptimalYieldShift_UserPoolZero_ReturnsZero() public {
        uint256 optimalShift = YieldShiftCalculationLibrary.calculateOptimalYieldShift(
     ...
     */
    function test_CalculateOptimalYieldShift_AtTargetRatio_ReturnsBaseShift() public {
        uint256 optimalShift = YieldShiftCalculationLibrary.calculateOptimalYieldShift(
     ...
     */
    function test_CalculateOptimalYieldShift_UserPoolLarger_IncreasesShift() public {
        uint256 optimalShift = YieldShiftCalculationLibrary.calculateOptimalYieldShift(
     ...
     */
    function test_CalculateOptimalYieldShift_HedgerPoolLarger_DecreasesShift() public {
        uint256 optimalShift = YieldShiftCalculationLibrary.calculateOptimalYieldShift(
     ...
     */
    function test_CalculateOptimalYieldShift_ClampsToMax() public {
        uint256 optimalShift = YieldShiftCalculationLibrary.calculateOptimalYieldShift(
     ...
     */
    function test_ApplyGradualAdjustment_AtTarget_ReturnsSame() public {
     ...
     */
    function test_ApplyGradualAdjustment_TowardHigherTarget_Increases() public {
        uint256 currentShift = 5000;
     ...
     */
    function test_ApplyGradualAdjustment_TowardLowerTarget_Decreases() public {
     ...
     */
    function test_ApplyGradualAdjustment_MinimumAdjustment() public {
        uint256 currentShift = 5000;
     ...
     */
    function test_ApplyGradualAdjustment_RespectsSpeed() public {
        uint256 currentShift = 5000;
     ...
     */
    function test_CalculateUserAllocation_ReturnsComplement() public {
     ...
     */
    function test_CalculateHedgerAllocation_ReturnsShift() public {
     ...
     */
    function test_Allocations_SumTo10000() public {
     ...
     */
    function test_CalculatePoolTWAP_EmptySnapshots_ReturnsZero() public {
     ...
     */
    function test_CalculatePoolTWAP_SingleSnapshot() public {
     ...
     */
    function test_CalculatePoolTWAP_RecentWeightedMore() public {
     ...
     */
    function test_CalculateYieldDistribution_SumsToTotal() public {
     ...
     */
    function test_CalculateYieldDistribution_AllToUsers() public {
        uint256 totalYield = 10000e18;
     ...
     */
    function test_CalculateYieldDistribution_AllToHedgers() public {
        uint256 totalYield = 10000e18;
     ...
     */
    function testFuzz_Allocations_AlwaysSumTo10000(uint16 yieldShift) public {
