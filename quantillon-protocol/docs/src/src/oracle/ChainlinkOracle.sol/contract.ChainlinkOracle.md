# ChainlinkOracle
[Git Source](https://github.com/Quantillon-Labs/smart-contracts/quantillon-protocol/blob/33d218e93a34affdd8776e90bfbc756888be6ca6/src/oracle/ChainlinkOracle.sol)
...
- Validates _timeProvider is not address(0)

- Sets timeProvider immutable variable and disables initializers

- No events emitted

- Throws "Zero address" if _timeProvider is address(0)
