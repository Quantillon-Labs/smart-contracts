...
interface ISlippageMidSource {
     ...
     * @param sourceId Source identifier (SOURCE_LIGHTER = 0)
...
/**
 * @title LighterEurUsdOracle
 * @notice EUR/USD oracle for Quantillon that mirrors the Lighter EURUSD (market_id 96) mid used to
 ...
 * @custom:security-contact team@quantillon.money
 */
contract LighterEurUsdOracle is
    IHyperliquidOracle,
    Initializable,
    ...
    IVersioned
{
    ...
    /// @notice SlippageStorage contract holding the published Lighter mid
    ...
    /// @notice Slippage source id to read (SOURCE_LIGHTER = 0)
     ...
     * @return eurUsdFresh True if the Lighter mid is fresh and positive
     ...
     * @param _sourceId New slippage source id (SOURCE_LIGHTER = 0)
