# IMockAaveVault
[Git Source](https://github.com/Quantillon-Labs/smart-contracts/quantillon-protocol/blob/0c6311949cabadbce9e79a7dafc6269035f6039e/src/interfaces/IMockAaveVault.sol)
...
Interface for the MockAaveVault (Aave V3 USDC yield vault)

Mirrors the external/public API of `src/core/vaults/MockAaveVault.sol`
...
Initializes the MockAaveVault contract with required addresses
